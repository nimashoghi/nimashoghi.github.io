...
Recent Updates
======
* **[Sep 2024]** I gave an **invited talk** on [Unlocking the Potential of Pre-training for Accelerated Discovery in Chemistry](https://nima.sh/aisi-presentation) at the AI for Science Institute (AISI) Beijing.
* **[Aug 2024]** I gave an **invited talk** on [Unlocking the Potential of Pre-training for Accelerated Discovery in Chemistry](https://nima.sh/ml2md) at the 2024 Machine Learning for Materials and Molecular Discoveries Symposium in Gothenburg, Sweden.
...
* **[Jul 2024]** I gave an **invited talk** on [From Molecules to Materials: Pre-training Large Generalizable Models for Atomic Property Prediction](https://nima.sh/jmp-kaust) at King Abdullah University of Science and Technology (KAUST).
* **[Jun 2024]** I gave an **invited talk** on [From Molecules to Materials: Pre-training Large Generalizable Models for Atomic Property Prediction](https://nima.sh/jmp-sesai) at SES AI.
...
* **[Apr 2024]** I gave an **invited talk** on [From Molecules to Materials: Pre-training Large Generalizable Models for Atomic Property Prediction](https://nima.sh/jmp-molecularml-presentation) at the Molecular ML Reading Group. [[Video]](https://youtu.be/HCtBvtHO5Gk)
